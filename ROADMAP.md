...
### Property Timeline + Notes (COMPLETE)
- [x] Timeline builder aggregating all property events (13 event types)
- [x] Filterable timeline UI with dot-and-line visual + date grouping
- [x] Property notes with author/timestamp tracking
- [x] Timeline tab in Workspace sidebar
- [x] 20 unit tests

### Property Map Overview (COMPLETE)
- [x] Portfolio map on Dashboard with color-coded property pins
...
### Shared Report Viewer (COMPLETE)
- [x] Public `/shared/:token` route for viewing shared property reports (no auth)
- [x] Satellite map preview, measurement summary grid, damage annotations
